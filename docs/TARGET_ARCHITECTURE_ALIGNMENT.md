...
- **Platform build-outs (unblocking Batch E/D):** ✅ private file uploads (`POST /api/v1/files`, signed downloads, migration `0017_stored_files`) and ✅ dashboard (`GET /api/v1/dashboard/stats`, now routed) implemented and tested.
